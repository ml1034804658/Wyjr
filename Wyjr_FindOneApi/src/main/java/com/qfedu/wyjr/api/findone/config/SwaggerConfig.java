package com.qfedu.wyjr.api.findone.config;
...
public class SwaggerConfig {
    ...
    public ApiInfo createA(){
        ApiInfo info=new ApiInfoBuilder().title("我要捡人-数据接口平台").
                contact( new Contact("zy","129.211.85.189/OJSystem","18791626830@163.com")).
                description("实现我要捡人项目的数据接口").build();
        return info;
    }
    /**
     * 创建API应用
    ...
    public Docket createDocket(){
       Docket docket=new Docket(DocumentationType.SWAGGER_2).apiInfo(createA()).select().
               apis(RequestHandlerSelectors.basePackage("com.qfedu.wyjr.api.findone.controller")).
               build();
       return docket;
    }
}